...
public:
    ...
    inline void setFont(const uint16_t *font)
    {
            ...
            (_font == Times_New_Roman66x53))
        {
            ...
            _f_cp1251 = false;
            _f_cp1252 = false;
            _f_cp1253 = false; // font can handle UTF-8
        }
        else
            _f_utf8 = false;
            ...
            (_font == Garamond88x108))
        {
            ...
            _f_cp1251 = false;
            _f_cp1252 = true;
            _f_cp1253 = false; // font can handle CP1252
        }
        else
            _f_cp1252 = false;
#endif // GARAMOND_H_
            ...
            (_font == Garamond107x108cyrillic))
        {
            ...
            _f_cp1251 = true;
            _f_cp1252 = false;
            _f_cp1253 = false; // font can handle CP1251
        }
        else
            _f_cp1251 = false;
            ...
            (_font == Garamond85x80greek))
        {
            ...
            _f_cp1251 = false;
            _f_cp1252 = false;
            _f_cp1253 = true; // font can handle CP1253
        }
        else
            _f_cp1253 = false;
...
private:
    ...
    inline void TFT_DC_HIGH()
    {
        ...
        {
            GPIO.out1_w1ts.data = (1 << (TFT_DC - 32));
        }
    }
    inline void TFT_DC_LOW()
    {
        ...
        {
            GPIO.out1_w1tc.data = (1 << (TFT_DC - 32));
        }
    }
    inline void TFT_CS_HIGH()
    {
        ...
        {
            GPIO.out1_w1ts.data = (1 << (TFT_CS - 32));
        }
    }
    inline void TFT_CS_LOW()
    {
        ...
        {
            GPIO.out1_w1tc.data = (1 << (TFT_CS - 32));
        }
    }
...
private:
    ...
    inline int16_t imul_b1_b3(int16_t w)
    { // 1/cos(4*pi/16)[362, 256+106]
        long x = (w * 362L);
        x += 128L;
        return (int16_t)(arithmeticRightShift8L(x));
    }
    inline int16_t imul_b2(int16_t w)
    { // 1/cos(6*pi/16)[669, 256+256+157]
        long x = (w * 669L);
        x += 128L;
        return (int16_t)(arithmeticRightShift8L(x));
    }
    inline int16_t imul_b4(int16_t w)
    { // 1/cos(2*pi/16)[277, 256+21]
        long x = (w * 277L);
        x += 128L;
        return (int16_t)(arithmeticRightShift8L(x));
    }
    inline int16_t imul_b5(int16_t w)
